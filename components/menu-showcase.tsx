...
const menuItems: MenuItem[] = [
  {
    ...
    descZh: '台灣蜜香紅茶，每日手煮 Q 彈珍珠',
    descEn: 'Honey-scented black tea imported from Taiwan, tapioca pearls cooked fresh daily',
    descEs: 'Té negro miel importado de Taiwán, perlas cocinadas frescas cada día',
    price: '$6.45',
  ...
  },
  {
    ...
    descZh: '紅燒牛肉湯底慢燉一整天，配Q彈麵條',
    descEn: 'Slow-simmered all day — rich braised beef broth with springy noodles',
    descEs: 'Caldo de res estofada cocido todo el dia, con fideos al estilo tradicional',
