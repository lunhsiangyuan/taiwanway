#!/usr/bin/env python3
"""
Download Square payments for 2024 (Jan 1 to Dec 31)
"""
import os
import json
import csv
...
OUTPUT_JSON = OUTPUT_DIR / "payments_2024_full.json"
OUTPUT_CSV = OUTPUT_DIR / "payments_2024_full.csv"
...
def download_payments():
    ...
    while True:
        ...
        try:
            ...
            print(f"\rPage {page}: Retrieved {len(payments)} records (Total: {len(all_payments)})", end="")
            sys.stdout.flush()
