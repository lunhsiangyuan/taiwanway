#!/usr/bin/env python3
"""
Merge 2024 data with existing dataset and check for duplicates.
"""
import csv
import json
...
NEW_DATA_CSV = DATA_DIR / "payments_2024_full.csv"
...
def main():
    ...
    # Read new data
    print(f"\n2. Reading 2024 data from {NEW_DATA_CSV}...")
    new_payments = read_csv_payments(NEW_DATA_CSV)
    print(f"   Found {len(new_payments)} new records")
    
    # Merge and deduplicate
    print("\n3. Merging and checking for duplicates...")
    merged_payments, stats = merge_and_deduplicate(existing_payments, new_payments)
    ...
    print(f"New records (2024):   {stats['new_count']:,}")
