...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'TaiwanWay | Taiwan Street Bowls + Bubble Bar in Middletown, NY',
    description: 'A home-style Taiwanese café in Middletown, NY 10940. Slow-braised beef noodle soup, classic braised pork rice, handcrafted bubble tea, and freshly baked pineapple cakes. Made by hand, served with warmth.',
    url: '/',
