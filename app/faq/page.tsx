...
export const metadata: Metadata = {
  ...
  description:
    'Common questions about TaiwanWay 臺灣味 — hours, location, menu, delivery, and more. A home-style Taiwanese café in Middletown, NY.',
  alternates: {
    canonical: 'https://taiwanwayny.com/faq',
  },
  openGraph: {
    title: 'TaiwanWay FAQ — Hours, Menu, Delivery',
    description:
